...
namespace Core
{
	...
	public:
		...
		/// Semaphores related methods

		///////////////////////////////////////////////////////////////////////

		ISemaphore* InstantiateSemaphore(IDevice* _Device) override;
		...
		IFence* InstantiateFence(IDevice* _Device) override;
		...
		IBuffer* CreateBuffer(IDevice* _Device, BufferType _BufferType, size_t _BufferSize) override;
	};
}